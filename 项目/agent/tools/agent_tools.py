...
use_ids = ['1001','1002','1003','1004','1005','1006','1007','1008','1009','1010']
...
if __name__ == '__main__':
    # fetch_external_data 被 @tool 装饰后，变成了 LangChain 中的 StructuredTool 对象，
    #不再是一个可以直接通过 fetch_external_data() 调用的普通 Python 函数。
